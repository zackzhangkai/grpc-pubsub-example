...
var file_pubsub_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x40, 0x0a, 0x0e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x52, 0x65, 0x71,
	...
	0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x22, 0x2d,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x32, 0x8b, 0x01,
...
var file_pubsub_proto_depIdxs = []int32{
	0, // 0: proto.PubSubService.Publish:input_type -> proto.PublishRequest
	1, // 1: proto.PubSubService.Subscribe:input_type -> proto.SubscribeRequest
	3, // 2: proto.PubSubService.Publish:output_type -> google.protobuf.Empty
	2, // 3: proto.PubSubService.Subscribe:output_type -> proto.SubscribeResponse
